...
# This script enables a local image registry and maps the ports 80 and 443 from the local machine.
# The script adds the port mapping config from to the script at https://kind.sigs.k8s.io/docs/user/local-registry/
