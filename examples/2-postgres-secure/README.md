...
helm install --wait db bitnami/postgresql --version 14.3.3 --values https://raw.githubusercontent.com/zitadel/zitadel-charts/main/examples/2-postgres-secure/postgres-values.yaml
