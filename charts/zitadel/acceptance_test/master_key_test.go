...
func TestExplicitMasterkeyValue(t *testing.T) {
	...
	setValues := map[string]string{
		...
		"zitadel.secretConfig.Database.Postgres.User.Password":     "postgres",
		"zitadel.secretConfig.Database.Postgres.Admin.Password":    "postgres",
...
func TestExternalMasterkeySecretReference(t *testing.T) {
	t.Parallel()
