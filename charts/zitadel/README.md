...
![Version: 11.0.0-beta.5](https://img.shields.io/badge/Version-11.0.0--beta.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v4.14.0](https://img.shields.io/badge/AppVersion-v4.14.0-informational?style=flat-square)
...
- `imageRegistry` (only ever applied to the `kubectl` and `wait4x` tool images)
- `tools.wait4x.*` (see "Login waits for the backend natively" below)
- `zitadel.debug.*` (see "Debug ReplicaSet removed" below)
